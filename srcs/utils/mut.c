...
/*   Updated: 2022/12/01 11:38:52 by rkanmado         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	isometric(t_coords *c)
{
	...
	tmp = *c;
	c->x0 = (tmp.x0 - tmp.y0) * cos(0.83599);
	c->y0 = (tmp.x0 + tmp.y0) * sin(0.599) - tmp.z0;
	c->x1 = (tmp.x1 - tmp.y1) * cos(0.83599);
	c->y1 = (tmp.x1 + tmp.y1) * sin(0.599) - tmp.z1;
	return ;
}
